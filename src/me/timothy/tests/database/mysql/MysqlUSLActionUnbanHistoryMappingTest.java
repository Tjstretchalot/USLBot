...
import me.timothy.tests.database.USLActionUnbanHistoryMappingTest;

public class MysqlUSLActionUnbanHistoryMappingTest extends USLActionUnbanHistoryMappingTest {
	@Before
	public void setUp() {
