...
import me.timothy.tests.database.RepropagationRequestMappingTest;

public class MysqlRepropagationRequestMappingTest extends RepropagationRequestMappingTest {
	@Before
	public void setUp() {
