...
import me.timothy.tests.database.USLActionBanHistoryMappingTest;

public class MysqlUSLActionBanHistoryMappingTest extends USLActionBanHistoryMappingTest {
	@Before
	public void setUp() {
