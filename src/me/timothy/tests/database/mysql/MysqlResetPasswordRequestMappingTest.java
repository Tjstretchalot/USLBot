...
import me.timothy.tests.database.ResetPasswordRequestMappingTest;

public class MysqlResetPasswordRequestMappingTest extends ResetPasswordRequestMappingTest {
	@Before
	public void setUp() {
