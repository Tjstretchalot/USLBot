...
import me.timothy.tests.database.TemporaryAuthRequestMappingTest;

public class MysqlTemporaryAuthRequestMappingTest extends TemporaryAuthRequestMappingTest {
	@Before
	public void setUp() {
