...
import me.timothy.tests.database.RegisterAccountRequestMappingTest;

public class MysqlRegisterAccountMappingTest extends RegisterAccountRequestMappingTest {
	@Before
	public void setUp() {
